...
//	}
	...
	public RedisCacheManager cacheManager() {
		...
		return RedisCacheManager.builder(redisConnectionFactory()).cacheDefaults(cacheConfig)
				.withCacheConfiguration("clients", myDefaultCacheConfig(Duration.ofMinutes(5)))
				.withCacheConfiguration("clients", myDefaultCacheConfig(Duration.ofMinutes(1))).build();
	}
